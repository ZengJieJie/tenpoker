...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.arraytop = [NSMutableArray arrayWithObjects:@1, @2, @10, @4, @5, nil];
    self.arrayxiab = [NSMutableArray arrayWithObjects:@1, @2, @3, @4, nil];
...
-(void)pdgmaover{
    if(self.arraytop[0]==self.arrayxiab[0]&&self.arraytop[1]==self.arrayxiab[1]&&self.arraytop[3]==self.arrayxiab[2]&&self.arraytop[4]==self.arrayxiab[3]) {
        [self pauseTimer];
        [self showGameAlert];
...
- (IBAction)gmabackclcik:(id)sender {
    [self dismissViewControllerAnimated:YES completion:nil];
}
    ...
    if ([self loadbool:adcint]) {
        if (adcint==1) {
            if (_btn2.tag==10){
                ...
                [self.arraytop replaceObjectAtIndex:4 withObject:self.arraytop[0]];
                [self.arraytop replaceObjectAtIndex:0 withObject:@10];
                self.btn5.tag=5;
                self.btn5.alpha=1;
                self.btn1.tag=10;
            ...
            if (_btn1.tag==10){
                ...
                [self.arraytop replaceObjectAtIndex:3 withObject:self.arraytop[1]];
                [self.arraytop replaceObjectAtIndex:1 withObject:@10];
                self.btn4.tag=4;
                self.btn4.alpha=1;
                self.btn2.tag=10;
            ...
            if (_btn2.tag==10){
                [self.arraytop replaceObjectAtIndex:1 withObject:self.arraytop[3]];
            ...
            if (_btn1.tag==10){
                [self.arraytop replaceObjectAtIndex:0 withObject:self.arraytop[4]];
